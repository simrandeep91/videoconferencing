...
public class showFiles extends javax.swing.JFrame {
    ...
    showFiles(ArrayList files,String pip) {
        initComponents();
        jButton1.setEnabled(false);
        ip=pip;
        setLocationRelativeTo(null);
    ...
    private void showMails(ArrayList al)
    {
        ...
        {
            JOptionPane.showMessageDialog(this, "No files by this User", "Message", JOptionPane.OK_OPTION);
            return;
        }
        String header[]={"Files by User"};
