...
public class AVTransmit1 extends Thread{
    ...
    public AVTransmit1(MediaLocator locator,
			 String ipAddress,
			 String pb,
			 Format format) {
	...
	try {
            ...
            JOptionPane.showMessageDialog(MainFrame.container,"Switch on WebCam in IM Mode","Error", JOptionPane.OK_OPTION);
	...
	AVTransmit1 at = new AVTransmit1(new MediaLocator(args[i]),
